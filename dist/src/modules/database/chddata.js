...
var ChdData = /** @class */ (function () {
    function ChdData(database) {
        this.database = database;
    }
    ChdData.prototype.destroy = function () {
    };
    ChdData.prototype.getChdDataDB = function (code) {
        return this.database.transhis.getChdDataDB(code);
    };
    ChdData.prototype.existChdDataDB = function (code) {
        return this.database.transhis.existChdDataDB(code);
    };
    ChdData.prototype.getData = function (code) {
        var db = this.getChdDataDB(code);
        return db.getState();
    };
    ChdData.prototype.setData = function (code, data) {
        var db = this.getChdDataDB(code);
        return db.setState(data).write();
    };
    ChdData.prototype.update = function (days, end) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        end = end || new Date();
                        return [4 /*yield*/, Services.Database.ChdData.update(this, days, end)];
                    case 1:
                        _a.sent();
    ...
    ChdData.prototype.getAveragePrice = function (code) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.averagePrice(code)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
